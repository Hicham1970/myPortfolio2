...
By executing the file build.bat you can create an executable version of this application, it works in Window even you don't have Python on your environment.
